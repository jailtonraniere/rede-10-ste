...
export const members: Member[] = [
  ...
  { id:'m3', nome:'João Lima', telefone:'(71) 99999-1003', bairro:'Curuzu', municipio:'Salvador', parentId:'m1', status:'mobilizador_ativo', role:'mobilizador', isTeamMember:true, recordOrigin:'base', joinedAt:'2026-08-08', lastActivity:'2026-08-15', inviteCode:'JOAO10' },
  ...
  { id:'m7', nome:'Lucas Rocha', telefone:'(71) 99999-1007', bairro:'Curuzu', municipio:'Salvador', parentId:'m3', status:'mobilizador_ativo', role:'mobilizador', isTeamMember:true, recordOrigin:'base', joinedAt:'2026-08-10', lastActivity:'2026-08-14', inviteCode:'LUCAS10' },
